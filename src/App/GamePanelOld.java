...
public class GamePanelOld extends JPanel implements Runnable, KeyListener {
	...
	private static GamePanelOld instance;
	public static GamePanelOld instance() {
		if(instance == null) {
			GamePanelOld.instance = new GamePanelOld();
		}
		return GamePanelOld.instance;
	}

	private GamePanelOld() {
		super();
